...
According to the specification, the pipeline operator will have syntax similar to that of the [Hack programming language](https://docs.hhvm.com/docs/hack/expressions-and-operators/pipe/).
